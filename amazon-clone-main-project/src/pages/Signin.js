        ...
        <form className="w-[350px] mx-auto flex flex-col items-center">
          ...
          <div className="w-full border border-zinc-200 p-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button onClick={handleSigin} className='w-full py-1.5 text-sm font-normal rounded-sm bg-gradient-to-t from-[#f7dfa5] to-[#f0c14b] hover:bg-gradient-to-b border border-zinc-400 active:border-yellow-800 active:shadow-amazonInput'>Continue</button>
            </div>
