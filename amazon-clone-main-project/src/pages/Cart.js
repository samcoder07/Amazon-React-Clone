...
const Cart = () => {
  ...
  return (
    <div className='w-full bg-gray-100 p-4'>
    {
           ...
           <div>
             {
               products.map((item)=>(
                 ...
                 <div className='w-1/5'>
                   <img className='w-full h-44 object-contain' src={item.image} alt="ProductsImgs"/>
                 </div>
                 <div className='w-4/5'>
       ...
       <div initial={{y:70 , opacity:0}} animate={{y:0 , opacity:1}} transition={{delay: .5 , duration: .5}} className='flex justify-center items-center gap-4 py-10'>
       <div>
        <img src={emptyCart} alt='emptyCartImg' className='w-80 rounded-lg p-4 mx-auto'/>
       </div>
       <div className='w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg'>
        <h1 className='text-titleFont text-xl font-bold'>Your Cart feels lonely.</h1>
